...
import 'package:gs_erp/screens/users/registration.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  final ComponentUtil componentUtil = ComponentUtil();
          ...
          child: Padding(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Image.asset(
                      'assets/images/logo-cv.png', width: 350.0, height: 350.0),
                  const SizedBox(height: 16.0),
                  componentUtil.buildTextFormField(labelText: 'Username',
                  ...
                  const SizedBox(height: 16.0),
                  componentUtil.buildTextFormField(labelText: 'Password',
